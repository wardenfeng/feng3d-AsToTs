module feng3d {
    ...
    export class Scene3D extends Container3D {
		 ...
		 * @param object3D		3d对象
		 */
        public addedObject3d(object3D: Object3D) {
            if (is(object3D, Entity)) {
		 ...
		 * @param object3D	3d对象
		 */
        public removedObject3d(object3D: Object3D) {
		 ...
		 * 收集需要检测鼠标碰撞的实体
		 */
        public collectMouseCollisionEntitys() {
		 ...
		 * @param traverser 横越者
		 */
        public traversePartitions(traverser: PartitionTraverser) {
            var i: number;
		 ...
		 * @param partition		分区
		 */
        protected addPartitionUnique(partition: Partition3D) {
		 ...
		 */
        public registerPartition(entity: Entity) {
		 ...
		 */
        public unregisterPartition(entity: Entity) {
