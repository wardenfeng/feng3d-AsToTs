module feng3d {
	 ...
	 */
    export abstract class AnimatorBase extends Component implements IAsset {
        ...
        public stop() {
            ...
            if ($ticker.hasEventListener(Event.ENTER_FRAME))
                $ticker.removeEventListener(Event.ENTER_FRAME, this.onEnterFrame);
		 ...
		 * @inheritDoc
		 */
        public abstract setRenderState(renderable: IRenderable, camera: Camera3D);
