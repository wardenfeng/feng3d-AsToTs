module feng3d {
    ...
    export class Context3DBufferOwner extends Component {
        ...
        public addChildBufferOwner(childBufferOwner: Context3DBufferOwner) {
            ...
            //添加事件
            childBufferOwner.addEventListener(Context3DBufferOwnerEvent.ADD_CONTEXT3DBUFFER, this.bubbleDispatchEvent);
            childBufferOwner.addEventListener(Context3DBufferOwnerEvent.REMOVE_CONTEXT3DBUFFER, this.bubbleDispatchEvent);
            childBufferOwner.addEventListener(Context3DBufferOwnerEvent.ADDCHILD_CONTEXT3DBUFFEROWNER, this.bubbleDispatchEvent);
            childBufferOwner.addEventListener(Context3DBufferOwnerEvent.REMOVECHILD_CONTEXT3DBUFFEROWNER, this.bubbleDispatchEvent);
            //派发添加子项缓冲拥有者事件
        ...
        public removeChildBufferOwner(childBufferOwner: Context3DBufferOwner) {
            ...
            //移除事件
            childBufferOwner.removeEventListener(Context3DBufferOwnerEvent.ADD_CONTEXT3DBUFFER, this.bubbleDispatchEvent);
            childBufferOwner.removeEventListener(Context3DBufferOwnerEvent.REMOVE_CONTEXT3DBUFFER, this.bubbleDispatchEvent);
            childBufferOwner.removeEventListener(Context3DBufferOwnerEvent.ADDCHILD_CONTEXT3DBUFFEROWNER, this.bubbleDispatchEvent);
            childBufferOwner.removeEventListener(Context3DBufferOwnerEvent.REMOVECHILD_CONTEXT3DBUFFEROWNER, this.bubbleDispatchEvent);
            //派发添加子项缓冲拥有者事件
