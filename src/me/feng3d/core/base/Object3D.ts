module feng3d {
    ...
    export class Object3D extends Component {
        ...
        public dispatchEvent(event: Event): boolean {
            if (is(event, MouseEvent3D) && this.parent && !this.parent.ancestorsAllowMouseEnabled) {
                if (this.parent) {
        ...
        public get sceneVisible(): boolean {
            ...
            return this.visible && (this.scene != null) && ((is(this.parent, Scene3D)) ? true : (this.parent ? this.parent.sceneVisible : false));
        }
