module feng3d {
    ...
    export class Component extends EventDispatcher {
        ...
        public getComponentByName(componentName: string): Component {
            var filterResult: Component[] = this.getComponentsByName(componentName);
		 ...
		 * @return 					获取到的组件
		 */
        public getComponentsByName(componentName: string): Component[] {
            var filterResult: Component[] = this.components.filter(function(item: Component, ...args): boolean {
		 ...
		 * @return
		 */
        public getComponentByClass(cls): any {
		 ...
		 */
        public getComponentsByClass(cls): Component[] {
            var filterResult: Component[] = this.components.filter(function(item: Component, ...args): boolean {
